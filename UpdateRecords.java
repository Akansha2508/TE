...
pw.println("<center>");
pw.println("<div>");
pw.println("<h1><u><b>Enter The Information(update)</b></u></h1>");
pw.println("</div>");
...
pw.println("<BR>your new usertype is:<input type=text readonly=true name=usertype value="+t+">");
pw.println("</pre>");
}
}
catch(Exception e)
...
pw.println("<BR><a href=Student>BACK</a>");
pw.println("</center>");
pw.println("</body>");
pw.println("</html>");
DBInfo.close();
