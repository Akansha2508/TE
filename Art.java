...
pw.println("</table>");
pw.println("</font>");
pw.println("<h2>Art..</h2>");
pw.println("<pre>");
pw.println("<blockquote>");
pw.println("<p>Art is a diverse range of human activities and the products of those activities,</p>");
...
pw.println("<p>include the production of works of art, the criticism of art, the study of the history of art,</p>");
 ...
 pw.println("</blockquote>");
pw.println("</pre>");
pw.println("<form action=Like>");
pw.println("<input type=submit name=\"like\" value=\"like\">");
pw.println("</form>");
pw.println("<HR>");


pw.println("<form action=Comment>");
